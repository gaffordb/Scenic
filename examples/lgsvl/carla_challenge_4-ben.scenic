...
pos = OrientedPoint on lane.centerline
...
# PLACEMENT
egoDestination = OrientedPoint on turn.endLane.centerline
ego = ApolloCar at pos, facing roadDirection, with behavior DriveTo(egoDestination)
