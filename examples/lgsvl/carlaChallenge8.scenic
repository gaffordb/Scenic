...
intersec = Uniform(*network.intersections) # HACK for now to fix bug
...
ego = ApolloCar at ego_spawn_pt,
    with behavior DriveTo(OrientedPoint on ego_maneuver.endLane)
